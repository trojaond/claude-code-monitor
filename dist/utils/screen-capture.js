 ...
 * @internal
 */
function executeAppleScriptWithResult(script) {
    try {
 ...
 * @internal
 */
function parseWindowBounds(result) {
 ...
 * @internal
 */
function buildITerm2WindowBoundsScript(tty) {
 ...
 * @internal
 */
function buildTerminalAppWindowBoundsScript(tty) {
    const safeTty = sanitizeForAppleScript(tty);
    return `
tell application "System Events"
 ...
 * @internal
 */
function buildGhosttyWindowBoundsScript(titleTag) {
 ...
 * @internal
 */
async function captureITerm2(tty) {
 ...
 * @internal
 */
async function captureTerminalApp(tty) {
 ...
 * @internal
 */
async function captureGhostty(tty) {
 ...
 * @returns Base64-encoded PNG string if successful, null otherwise
 */
export async function captureTerminalScreen(tty) {
    if (!isMacOS()) {
        return null;
    }
