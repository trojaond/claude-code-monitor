...
export const SessionTable = memo(function SessionTable({ sessions, selectedIndex, taskSummaries, markedSessionIds, now, }) {
    return (_jsxs(Box, { flexDirection: "column", children: [_jsxs(Box, { children: [_jsx(Box, { width: 4, children: _jsx(Text, { bold: true, dimColor: true, children: '  # ' }) }), _jsx(Box, { width: COL_STATUS, children: _jsx(Text, { bold: true, dimColor: true, children: "STATUS" }) }), _jsx(Box, { flexGrow: 1, children: _jsx(Text, { bold: true, dimColor: true, children: "CWD" }) }), _jsx(Box, { width: COL_TERMINAL, children: _jsx(Text, { bold: true, dimColor: true, children: "TERMINAL" }) }), _jsx(Box, { width: COL_MODEL, children: _jsx(Text, { bold: true, dimColor: true, children: "MODEL" }) }), _jsx(Box, { width: COL_COST, children: _jsx(Text, { bold: true, dimColor: true, children: "COST" }) }), _jsx(Box, { width: COL_TASKS, children: _jsx(Text, { bold: true, dimColor: true, children: "TASKS" }) }), _jsx(Box, { width: COL_LAST, children: _jsx(Text, { bold: true, dimColor: true, children: "LAST" }) }), _jsx(Box, { width: COL_AGE, children: _jsx(Text, { bold: true, dimColor: true, children: "AGE" }) })] }), sessions.map((session, index) => {
