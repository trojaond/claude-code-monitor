...
async function runWithAltScreen(options = {}) {
    ...
    const instance = render(_jsx(Dashboard, { initialShowQr: options.qr, preferTailscale: options.preferTailscale, serverEnabled: options.serverEnabled }), { patchConsole: false });
    ...
    const handleResize = () => {
        ...
        lastRows = rows;
        instance.clear();
        instance.rerender(_jsx(Dashboard, { initialShowQr: options.qr, preferTailscale: options.preferTailscale, serverEnabled: options.serverEnabled }));
    };
